...
<html lang="en">
	...
	<body>
		...
		<div class="product-detail-container">
			...
			$rock_id = $_GET['rockNum'];
			$rock = "SELECT * FROM Rocks WHERE rock_id = ".$rock_id;
			$query = mysqli_query($conn, $rock);
				if (!$query) {
    				printf("Error: %s\n", mysqli_error($conn));
    				exit();
				}
			...
			echo "<ul class=\"product-description\">";
				...
				echo "<li><strong>Quantity Per Order: </strong>".$rockRow['quantity_per_order']."</li>";
				echo "<li><strong>Price Per Order: </strong>".$rockRow['price_per_order']."</li>";
				echo "<li><strong>Description: </strong>".$rockRow['description']."</li>";
			echo "</ul>";
		...
		<div id="order-div">
			<form action="#" onsubmit="return pushToDb();" id="purchase-form" class="needs-validation" novalidate>
			  <h5>Order Details</h5>
			  <div class="form-row">
			  ...
			  <h5>Total Price</h5>
			  <div class="form-group" id="price-display">
			  	$0.00
			  </div>	  	  	  
